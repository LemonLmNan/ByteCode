 ...
 * @author: Whn
 */
public class RuntimeVisibleParameterAnnotations_attribute extends MyAttribute{

    private int num_parameters;
    private List<Annotation_attributes> parameter_annotations;

    public RuntimeVisibleParameterAnnotations_attribute(int attribute_name_index, long attribute_length)throws Throwable{
